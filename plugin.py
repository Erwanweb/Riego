...
"""
<plugin key="ZZ-AIS7Z" name="RONELABS - Auto Irrigation Sys" author="ErwanBCN" version="2.3.9" externallink="https://ronelabs.com">
    <description>
        <h2>Automatic Irrigation System V2.3.9</h2><br/>
...
class BasePlugin:
    ...
    def onStart(self):
        Domoticz.Log("RONELABS Irrigation V2.3.9: onStart called")
